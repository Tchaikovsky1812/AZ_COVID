...
To see only the most recent 30 days of data, [see this view](monthly/index.html)
...
ggplot(total.tests, aes(x = date, y = runtotal)) + 
  ...
  geom_line(size = 1) +
  theme_me() +
  scale_x_date(name = element_blank(), labels = date_format("%b-%d"), breaks = "2 week") +
